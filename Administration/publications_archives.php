                                ...
                                <div class="col-xl-12">
                                    <div class="card">
                                        <div class="card-header">
                                            <h5>Publications archivées</h5>
                                            <p>Consultez ou remettez en ligne les publications archivées.</p>
                                        </div>
                                        <div class="card-block table-border-style">
                                            <div class="table-responsive">
                                                <table class="table table-hover">
                                                    ...
                                                    ?>
                                                    <tr>
													<?php if (empty($resultat)) { echo "<td><h6 class='m-0'>Il n'y a actuellement aucune publication archivée.</h6></td>"; } ?>
                                                        <td>
															<a href="<?php echo $url; ?>inc/actions/republier_publication.php?id=<?php echo $publication['id'];?>&titre=<?php echo $publication['titre'];?>"><img src="img/republier.png" style="display:inline; width:30px; height: 30px;"/></a>
														</td>
														<td>
                                                            <a href="modifier_publication.php?med=<?php echo $publication['id'];?>"><img style="display:inline; width:30px; height: 30px;" src="https://cdn-icons-png.flaticon.com/512/2040/2040995.png"/></a>
                                                        </td>
                                                        <td>
